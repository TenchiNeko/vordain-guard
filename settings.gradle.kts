...
include(":core:model")
include(":core:policy")
include(":core:policy-presets")
include(":core:policy-sync")
include(":core:pairing")
include(":core:crypto")
include(":core:events")
include(":core:status")
include(":core:status-report")
include(":core:audit-log")
include(":core:alert-center")
include(":core:sync-bundle")
include(":core:dev-relay")
