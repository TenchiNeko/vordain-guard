...
class ChildSecurityStatusEvaluator {
    fun evaluate(input: ChildSecurityStatusInput): ChildSecurityStatusReport {
        ...
        return ChildSecurityStatusReport(
            ...
            activePolicySource = input.activePolicySource?.takeIf(String::isNotBlank),
            activePolicyPreset = input.activePolicyPreset?.takeIf(String::isNotBlank),
            encryptedDnsBlockingEnabled = input.encryptedDnsBlockingEnabled,
            proxyBlockingEnabled = input.proxyBlockingEnabled,
            policyAllowDomainCount = input.policyAllowDomainCount,
            policyBlockDomainCount = input.policyBlockDomainCount,
